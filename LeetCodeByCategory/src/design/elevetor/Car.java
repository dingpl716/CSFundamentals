...
public class Car {
	...
	/**
	 * Add a pickup request to the car if the pick up floor is within highest and
	 * lowest floor, otherwise return -1.
	 * 
	 * @param request
	 * @return
	 */
	...
	public void moveNext() {
		...
		// else if (pickup != null && pickup.floor == currentFloor && pickup.direction
		// == currentDirection) {
		// pickupQueue.poll();
		// return Action.openDoor;
		// }
