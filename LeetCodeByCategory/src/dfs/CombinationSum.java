...
public class CombinationSum {
	 ...
	 * @param buff
	 */
	private void combinationSum(int[] candidates, int target, int preLevelStart, int currentSum,
	...
	/**
	 * 选出一个数加到buff里面 当Candidates里面有重复的数，并且Candidates里面的数能被重复使用的时候
	 * 
	 ...
	 * @param buff
	 */
	private void combinationSumWithDup(int[] candidates, int target, int preLevelStart, int currentSum,
			List<List<Integer>> results, List<Integer> buff) {
