...
public class CombinationSumIV {
	...
	/**
	 * 从nums里面找一些数，要求和为target。 返回有多少种可能性，这是一个全排列问题 也就是说不同的顺序认为是不同的
	 * 
	 ...
	 * num = [1, 2, 3] target = 4
	 * 
	 * 设S[t]是当target是t的时候解法的数量，那么 S[t] = sum(S[k]) + T, 其中 0 < k < t 并且 S[k] = 0 if
	 * t - k 不在array里面 T = 1, if t 在array里面，else 0 S[0] = 0, 因为全是正数 S[1] = 1 if 1 is
	 * in the arry, other wise 0 S[2] = S[1] + S[2], if 2 is in the array, S[3] =
	 * S[1] + S[2] + S[3], if 3 is in the array
	 * 
