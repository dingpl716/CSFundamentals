...
public class SearchForARange {
    ...
    /**
     * int mid = (left + right)/2 so, left <= mid < right so, in order to make sure
     * that we can decrease the searching range left has to be mid+1, but right
     * could be mid or mir - 1 in this case, it should be mid
     */
